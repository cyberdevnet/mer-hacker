...
export default function MigrateTool(ac) {
  const [loadingButtonConvertConfig, setloadingButtonConvertConfig] = useState(
    false
  );
  const [
    loadingButtonMigrateSwitchConfig,
    setloadingButtonMigrateSwitchConfig,
  ] = useState(false);
  ...
  useEffect(() => {
    ...
    async function ConvertConfig() {
      if (backupFileUploaded === true) {
        ...
        ac.dc.setswitchAlertModal(true);
        ac.dc.setAlertModalError(
          "Please upload a valid .txt file containing the configuration"
        );
        ac.dc.setswitchToolsTemplate(false);
        setshowLiveLogs(false);
    ...
    <div id="page-inner-main-templates">
          ...
          <div className="panel panel-default">
                ...
                <div className="panel panel-default">
                  ...
                  <div id="collapseOne" className="panel-collapse collapse in">
                    <div className="panel-body">
                      <p>
                        <strong>
                          Please read carefully before starting the migration.
                        </strong>
                      </p>

                      <dl>
                        <dt>
                          This script converts a cisco running-config into a
                          Meraki Switch-Port configuration and creates a
                          downloadable python file used to push the new
                          switchport configuration.
                        </dt>
                        <dt>
                          Before to convert and push the configuration be sure
                          to:
                        </dt>
                        <br />
                        <dt>
                          Check if the switch serial-number has been claimed for
                          you Organization
                        </dt>
                        <dt>
                          Check if the new switch has been added to the right
                          Network
                        </dt>
                      ...
                      <ul>
                        <li>
                          Insert the serial number or a list of comma-separated
                          serial-numbers
                        </li>
                        <li>
                          Load the Cisco running-config, the file must be in
                          .txt format
                        </li>
                        <li>Convert the configuration</li>
                        <li>Check the script</li>
                        <dt>
                          The script can be modified before the pushing the
                          configuration (basic knowledge of python required).
                        </dt>
                        <li>Download the script(optional).</li>
                        <li>Push the configuration to the meraki Switch</li>
                        <li>
                          Go to your Meraki dashboard and check if the
            ...
            <div className="panel-body">
              <div className="form-group">
                ...
                >
                  <input
                    ...
                    className="btn-file btn-file-primary"
                  />
                  <button className="btn-file btn-file-primary">
                    Load Backupfile
                  </button>
                </form>
                <div>
                  {messageFileUpload && <span>{messageFileUpload}</span>}
                </div>
              </div>
              ...
              <button
                ...
                onClick={(e) =>
                  !loadingButtonConvertConfig ? handleConvertConfig(e) : null
                }
              ...
              <button
                ...
                onClick={
                  !loadingButtonMigrateSwitchConfig ? HandleRestore : null
                }
      ...
      <div>
        ...
        >
          <div>
            <p>
              Are you sure you want to push the configuration to the switch{" "}
              {serialNumbers}?{" "}
            </p>
            <p className="text-secondary">
              <small>
                before pushing the configuration be sure the switch has been
                added to the right network and Access Policy is configured
              </small>
            </p>
          </div>
          <button
      ...
      <div className="row">
        <div className="col-xs-12">
          <div className="panel panel-default">
            {showLiveLogs ? (
              <div style={{ height: 700 }}>{lazyLog}</div>
            ) : (
              <div></div>
            )}

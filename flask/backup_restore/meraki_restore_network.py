...
# https://dashboard.meraki.com/api_docs#create-a-new-dashboard-administrator
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'balexey@cisco.com', 'hasApiKey': True, 'id': '566327653141950480', 'lastActive': 1598966191, 'name': 'Alexsey', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'devnetexpressattendee@cisco.com', 'hasApiKey': True, 'id': '566327653141948116', 'lastActive': 1600686602, 'name': 'DNE Attendee', 'networks': [], 'orgAccess': 'read-only', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'devnetexpressinstructor@cisco.com', 'hasApiKey': True, 'id': '566327653141948124', 'lastActive': 1597112131, 'name': 'DNE Instructor', 'networks': [], 'orgAccess': 'read-only', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'devnetmerakiadmin@cisco.com', 'hasApiKey': True, 'id': '566327653141931517', 'lastActive': 1590763490, 'name': 'DevNet Admin', 'networks': [{'access': 'full', 'id': 'L_566327653141856854'}], 'orgAccess': 'read-only', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'dmelamed@cisco.com', 'hasApiKey': True, 'id': '566327653141953933', 'lastActive': 1592313693, 'name': 'David Melamed', 'networks': [{'access': 'full', 'id': 'L_566327653141856846'}], 'orgAccess': 'none', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'jocreed@cisco.com', 'hasApiKey': True, 'id': '566327653141897885', 'lastActive': 1601435242, 'name': 'Jock Reed', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'unverified', 'authenticationMethod': 'Email', 'email': 'mcburgerhack@cisco.com', 'hasApiKey': True, 'id': '566327653141956305', 'lastActive': '', 'name': 'Burger Hack', 'networks': [{'access': 'full', 'id': 'L_566327653141856846'}], 'orgAccess': 'none', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'mdenapol@cisco.com', 'hasApiKey': True, 'id': '566327653141886093', 'lastActive': 1601469004, 'name': 'Matt Work', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
...
# https://dashboard.meraki.com/api_docs#mx-vpn-firewall
	...
	dashboard = session.put(puturl, json={'rules': [{'comment': '', 'policy': 'deny', 'protocol': 'tcp', 'srcPort': 'Any', 'srcCidr': 'Any', 'destPort': 'Any', 'destCidr': 'Any', 'syslogEnabled': True}, {'comment': 'Default rule', 'policy': 'allow', 'protocol': 'Any', 'srcPort': 'Any', 'srcCidr': 'Any', 'destPort': 'Any', 'destCidr': 'Any', 'syslogEnabled': True}], 'syslogEnabled': True}, headers=headers)
...
# Add Network: Lyoli-restore
	...
	# https://dashboard.meraki.com/api_docs#update-the-l3-firewall-rules-of-an-ssid-on-an-mr-network
		...
		dashboard = session.put(puturl, json={'authMode': 'open', 'availabilityTags': [], 'availableOnAllAps': True, 'bandSelection': 'Dual band operation', 'enabled': True, 'ipAssignmentMode': 'NAT mode', 'minBitrate': 11, 'name': 'testv', 'number': 5, 'perClientBandwidthLimitDown': 0, 'perClientBandwidthLimitUp': 0, 'splashPage': 'None', 'ssidAdminAccessible': False, 'visible': True}, headers=headers)
	# MR L3 firewall
	# https://dashboard.meraki.com/api_docs#update-the-l3-firewall-rules-of-an-ssid-on-an-mr-network
	...
	# https://developer.cisco.com/meraki/api/#/rest/api-endpoints/devices/update-network-device
		...
		dashboard = session.put(puturl, json={'address': '', 'beaconIdParams': {'major': 2, 'minor': 1, 'uuid': 'a543206b-7dc8-44d0-9d72-1d43d92aafd4'}, 'firmware': 'wireless-26-6-1', 'floorPlanId': None, 'lanIp': '192.168.128.17', 'lat': 41.4768238267966, 'lng': -81.5780643147326, 'mac': 'e0:55:3d:c0:73:56', 'model': 'MR52', 'name': 'Basement AP', 'serial': 'Q2LD-3Y7V-7Y2X', 'tags': ' LTV '}, headers=headers)
		puturl = 'https://api.meraki.com/api/v0/networks/{0}/devices/Q2GV-LDX2-53ZA'.format(str(networkid))
		dashboard = session.put(puturl, json={'address': '', 'firmware': 'camera-4-0', 'floorPlanId': None, 'lanIp': '192.168.128.12', 'lat': 37.4180951010362, 'lng': -122.098531723022, 'mac': '34:56:fe:a3:ef:f4', 'model': 'MV12W', 'serial': 'Q2GV-LDX2-53ZA', 'tags': ' API_demo ', 'wirelessMac': '34:56:fe:a3:ef:f5'}, headers=headers)
		...
		dashboard = session.put(puturl, json={'address': '', 'firmware': 'switch-12-14', 'floorPlanId': None, 'lanIp': '192.168.128.251', 'lat': 37.4180951010362, 'lng': -122.098531723022, 'mac': 'e0:55:3d:d2:4b:4c', 'model': 'MS220-8P', 'name': 'Basement switch', 'serial': 'Q2HP-225A-XA5C', 'switchProfileId': None}, headers=headers)
	except requests.exceptions.HTTPError as err:
		print(err,file=f)
...
def restore_switchports(ARG_APIKEY):
	...
	try:
		...
		payload = '{"number": 9, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 10, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 11, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 12, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 13, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 14, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 15, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 16, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 17, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 18, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 19, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 20, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 21, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 22, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 23, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 24, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 25, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 26, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 27, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 28, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 29, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 30, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 31, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 32, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 33, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 34, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 35, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 36, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 37, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 38, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 39, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 40, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 41, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 42, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 43, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 44, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 45, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 46, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 47, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 48, "name": null, "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 49, "name": null, "tags": null, "enabled": true, "poeEnabled": false, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 50, "name": null, "tags": null, "enabled": true, "poeEnabled": false, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 51, "name": null, "tags": null, "enabled": true, "poeEnabled": false, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 52, "name": null, "tags": null, "enabled": true, "poeEnabled": false, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		payload = '{"number": 8, "name": "", "tags": null, "enabled": true, "poeEnabled": true, "type": "trunk", "vlan": 1, "voiceVlan": null, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyNumber": null}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)

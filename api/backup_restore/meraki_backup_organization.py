...
def write_restore_header(file):
	...
	file.write("\n");
	file.write("\n");
	file.write("def restore_organization(ARG_ORGID, NET_ID, ARG_APIKEY, SERIAL_NUM, ARG_ORGNAME):\n");
	file.write("\n");
	file.write("\theaders = {\n");
...
def backup_organization(ARG_ORGID, NET_ID, ARG_APIKEY, SERIAL_NUM, ARG_ORGNAME):
	...
	filename = os.path.join(dirname, 'meraki_restore_organization.py')
	with open(filename, 'w') as file:
		...
		myNetworks = meraki.networks.get_organization_networks({"organization_id": ARG_ORGID})

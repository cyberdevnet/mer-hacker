...
# https://dashboard.meraki.com/api_docs#create-a-new-dashboard-administrator
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'fabrizio.rollo@nts.eu', 'hasApiKey': True, 'id': '967931', 'lastActive': 1605346383, 'name': 'Fabrizio Rollo', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': True}, headers=headers)
...
# Add Network: Heisenberg-Lab-restore
	...
	# https://developer.cisco.com/meraki/api/#/rest/api-endpoints/devices/update-network-device
		...
		dashboard = session.put(puturl, json={'address': 'Update address', 'firmware': 'Not running configured version', 'floorPlanId': None, 'lanIp': None, 'lat': 37.4180951010362, 'lng': -122.098531723022, 'mac': 'e0:cb:bc:3b:25:45', 'model': 'MS220-8P', 'name': 'Heisenber-Switch', 'serial': 'Q2HP-QSVT-LBLV', 'switchProfileId': None}, headers=headers)

...
# https://dashboard.meraki.com/api_docs#create-a-new-dashboard-administrator
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'devnetexpressattendee@cisco.com', 'hasApiKey': True, 'id': '566327653141948116', 'lastActive': 1605788403, 'name': 'DNE Attendee', 'networks': [], 'orgAccess': 'read-only', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'mdenapol@cisco.com', 'hasApiKey': True, 'id': '566327653141886093', 'lastActive': 1605897874, 'name': 'Matt Work', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': False}, headers=headers)

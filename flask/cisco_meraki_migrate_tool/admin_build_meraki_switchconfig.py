...
# Configuring Meraki Switchport from a Cisco Ios running-config
	...
	try:
		...
		f.flush()
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/1'
		print('Building configuration SwitchPort1 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/2'
		print('Building configuration SwitchPort2 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/3'
		print('Building configuration SwitchPort3 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/4'
		print('Building configuration SwitchPort4 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/5'
		print('Building configuration SwitchPort5 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/6'
		print('Building configuration SwitchPort6 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/7'
		print('Building configuration SwitchPort7 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/8'
		print('Building configuration SwitchPort8 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/9'
		print('Building configuration SwitchPort9 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/10'
		print('Building configuration SwitchPort10 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/11'
		print('Building configuration SwitchPort11 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/12'
		print('Building configuration SwitchPort12 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/13'
		print('Building configuration SwitchPort13 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/14'
		print('Building configuration SwitchPort14 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/15'
		print('Building configuration SwitchPort15 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/16'
		print('Building configuration SwitchPort16 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/17'
		print('Building configuration SwitchPort17 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/18'
		print('Building configuration SwitchPort18 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/19'
		print('Building configuration SwitchPort19 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/20'
		print('Building configuration SwitchPort20 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/21'
		print('Building configuration SwitchPort21 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/22'
		print('Building configuration SwitchPort22 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/23'
		print('Building configuration SwitchPort23 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/24'
		print('Building configuration SwitchPort24 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/25'
		print('Building configuration SwitchPort25 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/26'
		print('Building configuration SwitchPort26 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/27'
		print('Building configuration SwitchPort27 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/28'
		print('Building configuration SwitchPort28 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/29'
		print('Building configuration SwitchPort29 switch aaaa-1112-jjjj',file=f)
		f.flush()
		...
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		print('Response: ',response.status_code,file=f)
		puturl = 'https://api.meraki.com/api/v0/devices/aaaa-1112-jjjj/switchPorts/30'
		print('Building configuration SwitchPort30 switch aaaa-1112-jjjj',file=f)
		f.flush()

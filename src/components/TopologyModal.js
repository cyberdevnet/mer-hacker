                    ...
                    <div >
                        ...
                        <div className="modal-body text-center"
                            ...
                            <table className="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">Name</th>
                                        <td>{ac.dc.model.name}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">Description</th>
                                        <td>{ac.dc.model.description}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">Connected to</th>
                                        <td>{ac.dc.sourceDeviceName}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">Port</th>
                                        <td>{ac.dc.model.switchport}</td>


                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">VLAN</th>
                                        <td>{ac.dc.model.vlan}</td>


                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">IP address</th>
                                        <td>{ac.dc.model.ipaddress}</td>


                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">MAC address</th>
                                        <td>{ac.dc.model.mac}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">CDP</th>
                                        <td>{ac.dc.model.cdp}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">clientVpnConnections</th>
                                        <td>{ac.dc.model.clientVpnConnections}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">ip6</th>
                                        <td>{ac.dc.model.ip6}</td>
                                    </tr>

                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">lldp</th>
                                        <td>{ac.dc.model.lldp}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">manufacturer</th>
                                        <td>{ac.dc.model.manufacturer}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">os</th>
                                        <td>{ac.dc.model.os}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">recentDeviceMac</th>
                                        <td>{ac.dc.model.recentDeviceMac}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">smInstalled</th>
                                        <td>{ac.dc.model.smInstalled}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">ssid</th>
                                        <td>{ac.dc.model.ssid}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">status</th>
                                        <td>{ac.dc.model.status}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">user</th>
                                        <td>{ac.dc.model.user}</td>
                                    </tr>
                                    <tr>
                                        <th style={{ width: '100%', float: 'left' }} scope="row">wirelessCapabilities</th>

...
# https://dashboard.meraki.com/api_docs#create-a-new-dashboard-administrator
	...
	dashboard = session.post(posturl, json={'accountStatus': 'ok', 'authenticationMethod': 'Email', 'email': 'fabrizio.rollo@nts.eu', 'hasApiKey': True, 'id': '967931', 'lastActive': 1615287527, 'name': 'Fabrizio Rollo', 'networks': [], 'orgAccess': 'full', 'tags': [], 'twoFactorAuthEnabled': True}, headers=headers)
...
# Add Network: Heisenberg-Lab-restore
	...
	# https://developer.cisco.com/meraki/api/#/rest/api-endpoints/devices/update-network-device
		...
		dashboard = session.put(puturl, json={'address': 'new address', 'firmware': 'Not running configured version', 'floorPlanId': None, 'lanIp': None, 'lat': 37.4180951010362, 'lng': -122.098531723022, 'mac': 'e0:cb:bc:3b:25:45', 'model': 'MS220-8P', 'name': 'Heisenberg-Switch', 'serial': 'Q2HP-QSVT-LBLV', 'switchProfileId': None}, headers=headers)
		puturl = 'https://api.meraki.com/api/v0/networks/{0}/devices/Q2KN-MEHN-SK32'.format(str(networkid))
		dashboard = session.put(puturl, json={'address': 'Schaeffergasse 20/44', 'firmware': 'wired-14-53', 'floorPlanId': None, 'lanIp': '192.168.0.22', 'lat': 48.19386, 'lng': 16.36354, 'mac': '0c:8d:db:92:1a:48', 'model': 'MX64', 'name': 'MX64-Heisenberg', 'serial': 'Q2KN-MEHN-SK32', 'tags': ' recently-added ', 'wan1Ip': '192.168.0.22', 'wan2Ip': None}, headers=headers)
		puturl = 'https://api.meraki.com/api/v0/networks/{0}/devices/Q2PD-M66A-L5TE'.format(str(networkid))
		dashboard = session.put(puturl, json={'address': 'Schaeffergasse 20 Wien', 'firmware': 'wireless-27-5-1', 'floorPlanId': None, 'lanIp': '192.168.128.10', 'lat': 48.19386, 'lng': 16.36354, 'mac': '98:18:88:73:18:ab', 'model': 'MR33', 'name': 'AP Kleines Zimmer', 'serial': 'Q2PD-M66A-L5TE', 'tags': ' recently-added '}, headers=headers)
	except requests.exceptions.HTTPError as err:
		print(err,file=f)
...
def restore_switchports(ARG_APIKEY,USER):
	...
	try:
		...
		f.flush()
		payload = '{"portId": "1", "name": "Test", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 100, "voiceVlan": 40, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		...
		f.flush()
		payload = '{"portId": "2", "name": "Test", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 100, "voiceVlan": 40, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "3", "name": "Test", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 100, "voiceVlan": 40, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "disabled", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "4", "name": "Client / Voice", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "5", "name": "Client / Voice", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "6", "name": "802.1X DOWN", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "7", "name": "Client / Voice", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "8", "name": "Client / Voice", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "9", "name": "802.1X DOWN", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
		...
		f.flush()
		payload = '{"portId": "10", "name": "802.1X DOWN", "tags": [], "enabled": true, "poeEnabled": true, "type": "access", "vlan": 999, "voiceVlan": 998, "allowedVlans": "all", "isolationEnabled": false, "rstpEnabled": true, "stpGuard": "bpdu guard", "linkNegotiation": "Auto negotiate", "portScheduleId": null, "udld": "Alert only", "accessPolicyType": "Custom access policy", "accessPolicyNumber": 1}'
		response = requests.request('PUT', puturl, headers=headers, data = payload)
	except requests.exceptions.HTTPError as err:
		print(err,file=f)
